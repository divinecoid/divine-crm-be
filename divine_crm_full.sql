...
\restrict oS7IdPO9vUvlmQwJgEhEfkmDeLW9rpkRtU3uo3JHjJYGERDfqXL4140vdW5Jjtp
...
--
-- Data for Name: ai_agents; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.ai_agents (id, name, ai_engine, basic_prompt, active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: ai_configurations; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.ai_configurations (id, ai_engine, token, endpoint, model, active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: broadcast_templates; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.broadcast_templates (id, name, content, type, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: chat_labels; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.chat_labels (id, label, description, color, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: chat_messages; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.chat_messages (id, contact_id, contact_name, message, response, status, assigned_to, assigned_agent, channel, labels, tokens_used, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: connected_platforms; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.connected_platforms (id, platform, token, client_id, client_secret, webhook_url, phone_number_id, active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: contacts; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.contacts (id, code, channel, channel_id, name, temperature, first_contact, last_contact, last_agent, last_agent_type, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: leads; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.leads (id, code, channel, channel_id, temperature, first_contact, last_contact, last_agent, last_agent_type, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.products (id, code, name, price, stock, uploaded_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: quick_replies; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.quick_replies (id, trigger, response, active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: token_balances; Type: TABLE DATA; Schema: public; Owner: divine_user
--

COPY public.token_balances (id, ai_engine, total_tokens, used_tokens, remaining_tokens, last_reset, created_at, updated_at) FROM stdin;
\.


--
-- Name: ai_agents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
--
-- Name: ai_configurations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--

SELECT pg_catalog.setval('public.ai_configurations_id_seq', 1, false);


--
-- Name: broadcast_templates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
--
-- Name: chat_labels_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--

SELECT pg_catalog.setval('public.chat_labels_id_seq', 1, false);


--
-- Name: chat_messages_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
--
-- Name: connected_platforms_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--

SELECT pg_catalog.setval('public.connected_platforms_id_seq', 1, false);


--
-- Name: contacts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
--
-- Name: leads_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
--
-- Name: products_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
--
-- Name: quick_replies_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--

SELECT pg_catalog.setval('public.quick_replies_id_seq', 1, false);


--
-- Name: token_balances_id_seq; Type: SEQUENCE SET; Schema: public; Owner: divine_user
--
...
\unrestrict oS7IdPO9vUvlmQwJgEhEfkmDeLW9rpkRtU3uo3JHjJYGERDfqXL4140vdW5Jjtp
